        ...
        <div className="flex w-full flex-col md:flex-row md:items-end md:justify-between gap-8">
          ...
          <div className="flex flex-col max-w-2xl">
            ...
            <p className="text-lg text-white/90 md:text-xl">
              Shamba helps cooperatives, NGOs, and sustainability programs
              know their farmers, map their land, and prove their impact,
              all in one place.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end">
            <Button size="lg" className="text-lg px-8 py-6 bg-white text-primary hover:bg-white/90" asChild>
              <a href="https://platform.shamba.land/signup" target="_blank" rel="noopener noreferrer">Request Access</a>
            </Button>
            <Button
              size="lg"
              variant="outline"
